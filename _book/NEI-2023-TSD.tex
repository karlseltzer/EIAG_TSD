...
2019 & 328.476 & 9513368 & 33726 & 8531797 & 187058 & 15529076 & 206207 & 2624113 & NA\\
2020 & 330.114 & 9620124 & 27430 & 8498334 & 200439 & 15794921 & 220422 & 2593854 & NA\\
2021 & 332.141 & 9761741 & 26559 & 8396295 & 224643 & 15940560 & 228949 & 2536547 & NA\\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
USDA Consumption at Home* & 3,172,566 & 3,172,566 & 12,158,936 & 5,457,592 & 1,305,599 & 163,281\\
USDA Commercial Consumption* & 1,708,305 & 1,708,305 & 6,547,120 & 2,938,703 & 700,901 & 87,921\\
...
\begin{table}[H]
\centering
\caption{\label{tab:comm-res-EFs}Commercial and Residential Cooking Emissions Factors}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\begin{table}[H]
\centering
\caption{\label{tab:res-EFs}Residential cooking emissions factors used to estimate the 90th percentile}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\midrule
1a & $R_{c,r} \times A_{r,a} \times N_{r,a}$ & $6 \times 51.9\% \times 1.43$ & 4.45 flat griddles in fast food restaurants\\
1b & $\sum_{r}(R_{c,r} \times A_{r,a} \times N_{r,a})$ & $\sum(Flat Griddles)$ & 9.5 flat griddles in all restaurants\\
1c & $\sum_{r}(R_{c,r} \times A_{r,a} \times N_{r,a}) \times T_{t,a} \times SF_{t}$ & $9.5 \times 9.4 \times 9.38\%$ & 8.38 tons of hamburger cooked on flat griddles\\
2a & $M_{c,t,a} \times EF_{t,a}$ & $8.38 \times 0.14 \div 2000$ & 0.00059 tons VOC emissions from cooking hamburgers on flat griddles\\
2b & $\sum_{t}(M_{c,t,a} \times EF_{t,a})$ & $\sum(VOC emissions)$ & 0.04 tons VOC emissions from flat griddles\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{tabular}[t]{lll}
\toprule
Pollutant & Avg. Wght. Percent & Emission Factor [lb/ton]*\\
\midrule
Naphtha & 40 & 760\\
