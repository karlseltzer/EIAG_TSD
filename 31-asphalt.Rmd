...
<div style="margin-left: 2em;">
  ...
  \( sp \) = sub-PADD associated with state *s*. sub-PADDs include the 11 districts included in the Asphalt Institute survey [[ref 1]](#asphalt-references) <br> \newline
</div>
...
kableExtra::kbl(
  df, booktabs = TRUE, 
  col.names = c("Pollutant", "Avg. Wght. Percent", "Emission Factor [lb/ton]*"),
  label = "cutback-EF"
) %>%
kable_styling(full_width = FALSE, position = "center", latex_options = c("scale_down", "H"))
```
